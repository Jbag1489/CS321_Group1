...
/**
 * The UserProfile will create a user profile to identify the status and
 * progress of the user.
 *
 * @author Group1 04/18/16
 */
public class UserProfile {
    ...
    /**
     * Creates a user profile with general attributes to identify a student or
     * an administrator.
     *
     * @param userName
     * @param studentName
     ...
     *
     * @param assignmentCounter The number of assignments the user has
     * completed.
     */
